...
static void G_Startup(void)
{
    ...
    if (numplayers > 1)
        //TIJN: Guess this isn't shown anymore!
...
//    flushlogwindow = 1;
    ...
    {
        //TIJN: I think this is old code for predefined number of players..
